        ...
        <?php
            ...
            <section id="customer">
                ...
                <div id="customer-results">
                    <div>
                    <a href="proses.php" class="btn btn-primary">Ekspor</a>
                    <a href="form.php" class="btn btn-primary">Impor</a>

                    <button id="add-button" class="btn btn-success btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addModal">
                        Tambah Detail Pelanggan <i class="fas fa-plus"></i>
                    </button>
