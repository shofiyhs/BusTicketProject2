        ...
        if ($ext == "xlsx") {
            ...
            foreach ($sheet as $row) { // Lakukan perulangan dari data yang ada di excel
                ...
                if ($numrow > 1) {
                    ...
                    $customer_id_td = (!empty($customer_id)) ? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
                    $customer_name_td = (!empty($customer_name)) ? "" : " style='background: #E07171;'"; // Jika Nama kosong, beri warna merah
                    $customer_phone_td = (!empty($customer_phone)) ? "" : " style='background: #E07171;'"; // Jika Jenis Kelamin kosong, beri warna merah
                    
                    // Jika salah satu data ada yang kosong
                    if ($customer_id == "" or $customer_name == "" or $customer_phone == "") {
